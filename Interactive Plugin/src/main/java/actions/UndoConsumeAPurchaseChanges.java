...
public class UndoConsumeAPurchaseChanges extends AbstractAction {
    private Project project;
    private Map<Integer, VirtualFile> files;
    private ToolWindow toolWindow;
    private String oldContent;
    public UndoConsumeAPurchaseChanges(Project project, Map<Integer, VirtualFile> files, ToolWindow toolWindow, String oldContent){
