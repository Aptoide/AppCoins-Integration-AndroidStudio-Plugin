...
public class ImplementQueryPurchasesSkuListenerChanges extends AbstractAction {
    private Project project;
    private Map<Integer, VirtualFile> files;
    public ImplementQueryPurchasesSkuListenerChanges(Project project, Map<Integer, VirtualFile> files){
        super("Static");
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        if (!oldContent.contains("SkuDetailsResponseListener")){
            listenerAndMethod= listenerAndMethod.concat(BillingToolWindowFactory.snippets.skuDetailsResponseListener());
            toImport=toImport.concat("\nimport com.appcoins.sdk.billing.listeners.SkuDetailsResponseListener;");
            if(!oldContent.contains("android.util.Log")){
                toImport=toImport.concat("\nimport android.util.Log;");
            }
            if(!oldContent.contains("appcoins.sdk.billing.SkuDetails")){
