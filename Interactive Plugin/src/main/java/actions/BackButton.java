...
public class BackButton extends AbstractAction {
    ...
    private int step;
    public BackButton(Project project, Map<Integer, VirtualFile> files, ToolWindow toolWindow, int step){
        super("Go back");
    ...
    public void actionPerformed(ActionEvent actionEvent) {
        ...
        switch (step){
            case 0:
                content = contentFactory.createContent(DialogCreator.introduction(project,files,toolWindow), "", false);
                break;
            case 1:
                content = contentFactory.createContent(DialogCreator.buildGradleDialog(project,files,toolWindow), "", false);
                break;
            case 2:
                content = contentFactory.createContent(DialogCreator.androidManifestDialog(project,files,toolWindow), "", false);
                break;
            case 3:
                if(files.get(4)!=null){
